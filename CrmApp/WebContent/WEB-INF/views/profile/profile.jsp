	...
	<div class="row">
		...
		<div class="col-md-8 col-xs-12">
			<div class="white-box">
				...
				<a class="btn btn-primary" href="<c:url value="/profile/edit" />" role="button">Sửa thông tin cá nhân</a>	
				<a class="btn btn-primary" href="<c:url value="/profile/changepwd" />" role="button">Thay đổi mật khẩu</a>
			</div>
		</div>
	</div>
</body>
